const YearCard = ({ imageSrc, title, courseText, onClick }) => {
  return (
    <div
      className="flex flex-col mb-5 cursor-pointer sm:m-4 md:m max-w-xs"
      onClick={onClick}
    >
      ...
      <div className="group px-4 mx-4 sm:px-6 md:px-8 py-3 rounded-lg -mt-6 shadow-lg shadow-gray-400 bg-gray-100 relative transition-transform duration-300 ease-in-out transform hover:scale-105">
